...
# Ses butonu oluşturma
audio_button_frame = CTkFrame(master=stats_frame, fg_color="#FFD700", width=132, height=70, corner_radius=8)
audio_button_frame.pack_propagate(0)
audio_button_frame.pack(anchor="w", side="left", padx=(0, 20))
audio_button = CTkButton(master=audio_button_frame, text="Ses", font=("Arial Bold", 10), text_color="#000000",
                         command=run_audio_test, fg_color="#FFD700")
audio_button.pack(anchor="nw")
...
movies_img_data1 = Image.open("foto1.png")
...
label1.bind("<Button-1>", on_image_click("foto1.png"))

movies_img_data2 = Image.open("foto2.jpg")
...
label2.bind("<Button-1>", on_image_click("foto2.jpg"))
